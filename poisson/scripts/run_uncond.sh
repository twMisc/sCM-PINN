...
# ------------------------------------------------------------
MODELS=(
    "sCM-PINN|cm|sep_unet|./poisson-diffpde-output/consistency-fdm/model_epoch/model_epoch_2.pth"
    "sCM-Base|cm|unet|./poisson-diffpde-output/consistency/model_epoch/model_epoch_8.pth"
    "DiffusionPDE|diffpde|unet|../DiffusionPDE_data/pretrained-models/pretrained-poisson.pkl"    
)
