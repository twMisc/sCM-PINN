...
from utils import consistency_sample_cm, sample_dpm_solver, poisson_loss
...
def main(device, batch_size, total_samples, model_path, save_path, save_name, seed, model_type, network_type, num_steps, cm_steps, figure_dir, network_name, rho):
    ...
    with torch.no_grad():
        for i in tqdm(range(0, total_samples, batch_size)):
            ...
            # We must squeeze the channel dimension before passing to poisson_loss
            ...
            # Now inputs are 3D, matching poisson_loss expectations
            residual_map = poisson_loss(u_tensor, a_tensor, return_residual=True)
