...
MY_PATH_TO_TEACHER = './poisson-diffpde-output/diffusion/model_epoch/model_epoch_10.pth'  # Path to pretrained diffusion model
...
@click.option('--save_path', default='./poisson-diffpde-output/consistency', help='Path to save model checkpoints and samples.')
