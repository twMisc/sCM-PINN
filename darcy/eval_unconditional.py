...
from utils import scale_back_a, scale_back_u, discrete_a
...
from utils import consistency_sample_cm, sample_dpm_solver, FDM_Darcy_loss
    ...
    with torch.no_grad():
        for i in tqdm(range(0, total_samples, batch_size)):
            ...
            if model_type == 'diffpde':
                ...
                a_samples = discrete_a(a_samples)
            ...
            # We must squeeze the channel dimension before passing to FDM_Darcy_loss
            ...
            # Now inputs are 3D, matching FDM_Darcy_loss expectations
            residual_map = FDM_Darcy_loss(u_tensor, a_tensor, use_mask=False, output_mask=False)
