...
TOTAL_SAMPLES=256
SEED=123
SAVE_PATH="./eval_results_inverse"
SAVE_NAME="task_error.csv"
FIGURE_BASE="./figures_inverse"
...
# ------------------------------------------------------------
MODELS=(
    # "consistency-fdm|cm|sep_unet|./helmholtz-output/consistency-fdm/model_epoch/model_epoch_2.pth"
    # "cm|cm|unet|./helmholtz-output/consistency/model_epoch/model_epoch_8.pth"
    "diffpde|diffpde|unet|../DiffusionPDE_data/pretrained-models/pretrained-helmholtz.pkl"    
    # "diffusion|diffusion|unet|./helmholtz-output/diffusion/model_epoch/model_epoch_10.pth"
)
