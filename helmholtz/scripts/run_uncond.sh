...
# ------------------------------------------------------------
MODELS=(
    "sCM-PINN|cm|sep_unet|./helmholtz-output/consistency-fdm/model_epoch/model_epoch_2.pth"
    "sCM-Base|cm|unet|./helmholtz-output/consistency/model_epoch/model_epoch_8.pth"
    "DiffusionPDE|diffpde|unet|../DiffusionPDE_data/pretrained-models/pretrained-helmholtz.pkl"    
)
